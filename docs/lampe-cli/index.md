...
| `LAMPE_MODEL_QUICK_REVIEW`                | (auto) | Model for quick review agent (optional).            |
| `LAMPE_MODEL_QUICK_REVIEW_HALLUCINATION_FILTER` | (auto) | Model for quick review hallucination filter (optional). |
